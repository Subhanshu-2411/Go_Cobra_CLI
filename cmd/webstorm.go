...
var webstormCmd = &cobra.Command{
	Use:   "webstorm <Zipped File Name>",
	Short: "Open a Zip Folder in WebStorm",
	Long: `It opens a Zipped Folder Present in your working directory 
in WebStorm with simple Arguments. Do Note to install WebStorm on Your System`,
	...
	Example:               `Go_Cobra_CLI webstorm hello.zip (or File Path)`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		commandCode := exec.Command("webstorm", wd)
		err = commandCode.Run()

		if err != nil {
			fmt.Println("WebStorm Executable File not found in %PATH%")
		}
	},
}
...
func init() {
	...
	webstormCmd.PersistentFlags().StringVarP(&File, "file", "f", "", "File Name to be Open")
