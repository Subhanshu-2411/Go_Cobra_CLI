...
// clionCmd represents the clion command
var clionCmd = &cobra.Command{
	Use:   "clion <Zipped File Name>",
	Short: "Open a Zip Folder in CLion",
	Long: `It opens a Zipped Folder Present in your working directory 
in Clion with simple Arguments. Do Note to install CLion on Your System`,
	...
	Example:               `Go_Cobra_CLI clion hello.zip (or File Path)`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		commandCode := exec.Command("clion", wd)
		err = commandCode.Run()

		if err != nil {
			fmt.Println("CLion Executable File not found in %PATH%")
		}
	},
}

func init() {
	rootCmd.AddCommand(clionCmd)
	...
	// clionCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
